...
for key, label, layout, matches in [
	("1", "", None, wm_class("VSCodium", "code", "jetbrains-clion", "dev.zed.Zed", "Windsurf", "Cursor")),
    ...
    ("4", "󰄄", None, wm_class("obsidian", "resolve", "darktable", "Rapid Photo Downloader", "krita", "Inkscape")),
